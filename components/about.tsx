          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 flex flex-col justify-center">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-muted px-3 py-1 rounded-full text-sm">📚 독서</span>
                <span className="bg-muted px-3 py-1 rounded-full text-sm">☕ 카페 투어</span>
                <span className="bg-muted px-3 py-1 rounded-full text-sm">🎨 전시회 관람</span>
                <span className="bg-muted px-3 py-1 rounded-full text-sm">✈️ 여행</span>
              </div>
            </div>
            
            {/* 이미지 영역 (이미지가 있다면 src에 경로 입력) */}
            <div className="bg-muted h-64 lg:h-auto min-h-[300px] flex items-center justify-center text-muted-foreground">
               {/* <img src="/내사진.jpg" alt="소개 이미지" className="w-full h-full object-cover" /> */}
               이미지 영역 (src 경로를 수정하세요)
            </div>
          </div>
        </div>
